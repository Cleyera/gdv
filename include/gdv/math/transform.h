#ifndef GDV_TRANSFORM_H_
#define GDV_TRANSFORM_H_
...
matrix4x4<Ty> look_at(vector3<Ty> pos, vector3<Ty> dst, vector3<Ty> up) noexcept {
    ...
    vector3<Ty> x = normalize(::gdv::cross(up, z));
    vector3<Ty> y = ::gdv::cross(z, x);
    return{
        x.x, y.x, z.x, -::gdv::dot(pos, x),
        x.y, y.y, z.y, -::gdv::dot(pos, y),
        x.z, y.z, z.z, -::gdv::dot(pos, z),
        _0, _0, _0, _1
    };
...
matrix4x4<Ty> look_at(vector3<Ty> pos, vector3<Ty> dst, vector3<Ty> up) noexcept {
    ...
    return{
        ...
        y.x, y.y, y.z, _0,
        z.x, z.y, z.z, _0,
        -::gdv::dot(pos, x), -::gdv::dot(pos, y), -::gdv::dot(pos, z), _1
    };
}
